...
<div>
    ...
    <main class="form-signin">
        <form @submit.stop.prevent="submit">
            <h1 class="h3 mb-3 fw-normal">Please edit you account</h1>
            
            <div class="form-floating">
                <input v-model="id" type="number" class="form-control" id="floatingInput" placeholder="Insert you ID">
            </div>
...
export default {
    ...
    methods:{
        submit(){
            ...
            fetch(`http://127.0.0.1:8000/api/user/${this.id}`, {
                method: 'PUT',
                headers: {
